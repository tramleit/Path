...
const UtilitiesPage = () => (
  ...
  <DocsPageLayout pageTitle='Utility classes' activeNav='/docs/utilities'>
    <div className='pb-4 pb-md-5'>
      ...
      <p>Along with <a href='https://getbootstrap.com/docs/5.1/utilities/borders/' className='fw-bold' target='_blank' rel='noreferrer'>default Bootstrap utility classes</a> Finder introduces its own. They all live inside <code>Finder/scss/_utilities.scss</code> file.</p>
