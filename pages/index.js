        ...
        <Container>
          <Link href='/' passHref>
            <Navbar.Brand className='me-2 me-xl-4'>
              <ImageLoader priority src='/images/logo/logo-dark.svg' width={116} height={32} alt='Finder' />
            </Navbar.Brand>
          </Link>
          <Navbar.Toggle aria-controls='navbarNav' className='ms-auto' />
          <Button href='#' size='sm' className='rounded-pill order-md-3 ms-2' target='_blank' rel='noreferrer'>
            ...
            <Nav navbarScroll style={{maxHeight: '35rem'}}>
              ...
              <Nav.Item>
                <Link href='/components/typography' passHref>
                  <Nav.Link>UI Kit (Components)</Nav.Link>
                </Link>
              </Nav.Item>
              <Nav.Item>
                ...
                <div className='pt-md-5 mt-4 me-md-n5'>
                  <h2 className='h4 mb-2 pb-1 ms-md-3'>
                    <Link href='/real-estate'>
                      <a className='nav-link stretched-link d-flex align-items-center justify-content-center justify-content-md-start'>
      ...
      <Container as='section' className='position-relative zindex-1'>
        <div className='bg-secondary rounded-3 px-3 py-5'>
          <div className='text-center py-sm-3 py-md-5'>
            ...
            <Button href='#' variant='primary rounded-pill' size='lg' target='_blank' rel='noreferrer'>
