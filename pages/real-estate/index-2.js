      ...
      <Container as='section' className='mt-n3 mt-md-0 mb-5 pb-2 pb-lg-4'>
        <div className='d-flex align-items-end justify-content-between pb-2'>
          ...
          <Link href='/real-estate/catalog?category=sale' passHref>
            <Button variant='link fw-normal ms-2 p-0'>
              View all
              ...
              <Row>
                ...
                <Col md={5} lg={4}>
                  ...
                  <ButtonGroup size='lg' className='scale-up delay-3'>
                    <Link href={property.href} passHref>
                    ...
                    {location.links.map((link, indx) => (
                      <Nav.Item key={indx} as='li' className='mb-2 pb-1'>
                        <Link href={link[0]} passHref>
                          <Nav.Link active={false} className='p-0 fw-normal'>{link[1]}</Nav.Link>
                        </Link>
                      </Nav.Item>
                    ))}
                  </Nav>
      ...
      <Container as='section' className='mb-5 pb-lg-5 pb-md-4'>
        <Card className='border-0 bg-secondary py-lg-5 py-4'>
          <Card.Body className='text-center p-4'>
            ...
            <Link href='#' passHref>
              <Button size='lg' className='w-sm-auto w-100'>
                Find agent
          ...
          <Col lg={7}>
            ...
            <div className='pt-2'>
              <Link href='/real-estate/blog' passHref>
                <Button size='lg' variant='outline-primary w-sm-auto w-100'>
                  More blog posts
                </Button>
              </Link>
            </div>
        ...
        <Row xs={1} md={3} className='gy-3'>
          ...
          <Col>
            <Card className='card-hover h-100 border-0 bg-faded-accent position-relative'>
              ...
              <Card.Footer className='py-1 border-0'>
                <Link href='/real-state/help-center' passHref>
                  <Button variant='link stretched-link text-accent mb-3 px-0'>Go to FAQs</Button>
                </Link>
              </Card.Footer>
            </Card>
          </Col>
          ...
          <Col>
            <Card className='card-hover h-100 border-0 bg-faded-success position-relative'>
              ...
              <Card.Footer className='py-1 border-0'>
                <Link href='/real-state/about' passHref>
                  <Button variant='link stretched-link text-success mb-3 px-0'>Get started</Button>
                </Link>
              </Card.Footer>
            </Card>
          </Col>
