    ...
    >
            ...
            <Card className='card-hover border-0 h-100 pb-2 pb-sm-3 px-sm-3 text-center mx-2'>
              ...
              <Card.Footer className='pt-0 border-0'>
                <Link href='/real-estate/catalog?category=sale' passHref>
                  <Button variant='outline-primary stretched-link'>Find a home</Button>
                </Link>
              </Card.Footer>
            </Card>
          </SwiperSlide>
            ...
            <Card className='card-hover border-0 h-100 pb-2 pb-sm-3 px-sm-3 text-center mx-2'>
              ...
              <Card.Footer className='pt-0 border-0'>
                <Link href='/real-estate/add-property' passHref>
                  <Button variant='outline-primary stretched-link'>Place an ad</Button>
                </Link>
              </Card.Footer>
            </Card>
          </SwiperSlide>
            ...
            <Card className='card-hover border-0 h-100 pb-2 pb-sm-3 px-sm-3 text-center mx-2'>
              ...
              <Card.Footer className='pt-0 border-0'>
                <Link href='/real-estate/catalog?category=rent' passHref>
                  <Button variant='outline-primary stretched-link'>Find a rental</Button>
                </Link>
              </Card.Footer>
            </Card>
          </SwiperSlide>
      ...
      <Container as='section' className='mb-5 pb-2 pb-lg-4'>
        <Row className='align-items-center'>
          ...
          <Col md={7} xxl={6} className='text-md-start text-center'>
            ...
            <p className='pb-3 fs-lg'>Real estate appraisal is a procedure that allows you to determine the average market value of real estate (apartment, house, land, etc.). Сalculate the cost of your property with our new Calculation Service.</p>
      ...
      <Container as='section' className='mb-5 pb-2'>
        <div className='d-flex align-items-center justify-content-between mb-3'>
          ...
          <Link href='/real-estate/catalog?category=rent' passHref>
            <a className='btn btn-link fw-normal ms-md-3 pb-0 pe-0'>
              View all
              <i className='fi-arrow-long-right ms-2'></i>
            </a>
          </Link>
          ...
          >
            {cities.map((city, indx) => (
              <SwiperSlide key={indx}>
                <Link href={city.href} passHref>
                  <Card as='a' className='card-hover shadow-sm border-0 mx-2'>
