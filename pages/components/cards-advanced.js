      ...
      <ComponentPageSection id='card-hover-overlay' title='Content overlay on hover'>
        <Tab.Pane eventKey='preview'>
          <div className='row align-items-center'>
            <div className='col-md-6 mb-4 mb-md-0'>
              <Link href='#' passHref>
                <Card as='a' className='card-hover shadow-sm border-0 mx-auto' style={{maxWidth: '306px'}}>
            ...
            <div className='col-md-6 bg-dark py-4'>
              <Link href='#' passHref>
                <Card as='a' className='card-hover card-light mx-auto' style={{maxWidth: '306px'}}>
                  <CardImageHoverOverlay
                    img={{
                      src: '/images/real-estate/city/chicago.jpg',
                      size: [306, 236],
...
{/* Default variant */}
<Link href='#' passHref>
  <Card as='a' className='card-hover shadow-sm border-0' style={{maxWidth: '306px'}}>
    <CardImageHoverOverlay
      img={{
        src: '/images/real-estate/city/chicago.jpg',
        size: [306, 236],
