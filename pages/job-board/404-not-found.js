            ...
            <Row className='gy-4'>
              ...
              <Col md={{span: 6, offset: 1}} lg={{span: 5, offset: 2}} className='text-md-start text-center'>
                ...
                <p className='lead mb-md-5 mb-4'>
                  The link you clicked may be broken or the page may have been removed. You can try the search box or get back to the <Link href='/job-board'><a>homepage</a></Link>.
                </p>
