        ...
        <Row className='pt-3'>
          <Col lg={8}>
            ...
            <div className='d-flex flex-wrap border-bottom pb-3 mb-4'>
              <Link href='#'>
                <a className='text-uppercase text-decoration-none border-end pe-3 me-3 mb-2'>Tips &amp; Advice</a>
              </Link>
              ...
              <div className='d-md-flex align-items-center justify-content-between border-top pt-4'>
                <div className='d-flex align-items-center me-3 mb-3 mb-md-0'>
                  ...
                  <div className='d-flex flex-wrap'>
                    <Link href='#' passHref>
                      <Button size='xs' variant='outline-secondary rounded-pill fs-sm fw-normal me-2 mb-2'>Resume</Button>
                    </Link>
                    <Link href='#' passHref>
                      <Button size='xs' variant='outline-secondary rounded-pill fs-sm fw-normal me-2 mb-2'>Tips</Button>
                    </Link>
                    <Link href='#' passHref>
                      <Button size='xs' variant='outline-secondary rounded-pill fs-sm fw-normal mb-2'>Jobs</Button>
                    </Link>
                  </div>
                </div>
                  ...
                  <Card.Body className='d-flex align-items-start'>
                    ...
                    <div className='ps-3'>
                      <h4 className='h5 mb-2'>
                        <Link href='#'>
                          <a className='nav-link stretched-link p-0 fw-bold'>Kristin Watson</a>
                        </Link>
                      </h4>
