...
const HomePage = () => {
  ...
  const PriceRange = () => {
    ...
    const [maxRange, setMaxRange] = useState(14000)
    ...
    return (
      <>
        <div className='range-slider range-slider-light'>
          <Nouislider
              ...
              <div className='d-sm-flex align-items-center'>
                ...
                <Card.Body className='text-center text-sm-start'>
                  ...
                  <Link href='/job-board/catalog' passHref>
                    <a className='fw-bold text-decoration-none py-1'>
                      Find jobs
        ...
        <Row className='gy-3'>
          ...
          <Col xs={12} md={5} className='text-center text-md-start'>
            ...
            <Link href='/job-board/post-resume-1' passHref>
              <Button size='lg' variant='primary rounded-pill' className='ms-sm-auto'>
                Post resume
              ...
              <SwiperSlide key={indx} className='h-auto' style={{padding: '.75rem .75rem 1rem .75rem'}}>
                <div className='position-relative text-center'>
                  ...
                  <Link href={city.href} passHref>
                    <a className='nav-link stretched-link p-0'>
                      {city.name}
                    </a>
                  </Link>
