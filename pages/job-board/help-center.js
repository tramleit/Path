          ...
          <Col>
            <Card border='0' className='shadow-sm card-hover position-relative h-100'>
              ...
              <Card.Footer className='pt-0 border-0'>
                <Link href='/job-board/help-center-single'>
                  <a className='nav-link my-1 px-0 stretched-link'>
                    Find question
            ...
            <Card border='0' className='shadow-sm card-hover position-relative h-100'>
              ...
              <Card.Footer className='pt-0 border-0'>
                <Link href='/job-board/help-center-single' passHref>
                  <Button variant='link' className='px-0 stretched-link'>
                    Find question
                    <i className='fi-chevron-right ms-2 mt-n1 align-middle fs-xs'></i>
                  </Button>
                </Link>
        ...
        <Col sm={10} xs={11} className='d-flex flex-md-row flex-column align-items-center justify-content-between'>
          <div className='order-md-1 order-2 text-md-start text-center' style={{maxWidth: '524px'}}>
            ...
            <Link href='/job-board/contacts' passHref>
              <Button size='lg' variant='primary rounded-pill' className='w-sm-auto w-100'>
                Contact us
              </Button>
            </Link>
          </div>
