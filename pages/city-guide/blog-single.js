    ...
    >
      ...
      <Container className='mt-5 mb-md-3 mb-lg-4 py-5'>
        ...
        <Row className='mt-4 pt-3'>
          ...
          <Col ref={offcanvasContainer} as='aside' lg={4}>
            <Offcanvas
              ...
              className='offcanvas-expand-lg pe-lg-3'
            >
              ...
              <Offcanvas.Body>
                  ...
                  <Card.Body className='d-flex align-items-start'>
                    ...
                    <div className='ps-3'>
                      <h4 className='h5 mb-2'>
                        <Link href='#'>
                          <a className='nav-link stretched-link p-0 fw-bold'>Bessie Cooper</a>
                        </Link>
                      </h4>
                ...
                <Card className='card-flush pb-2 pb-lg-0 mb-4'>
                  <Card.Body>
                    ...
                    {categories.map((category, indx) => (
                      <Link key={indx} href={category[0]}>
                        <a className='nav-link fw-normal d-flex justify-content-between py-1 px-0'>
                          {category[1]}
                ...
                <Card className='card-flush pb-2 pb-lg-0 mb-4'>
                  <Card.Body>
                    ...
                    {tags.map((tag, indx) => (
                      <Link key={indx} href={tag[0]} passHref>
                        <Button size='xs' variant='outline-secondary rounded-pill fs-sm fw-normal me-2 mb-2'>{tag[1]}</Button>
                      </Link>
                    ))}
                  </Card.Body>
                </Card>
                  ...
                  <Card.Body>
                    ...
                    <Form.Text className='d-block fs-xs pt-1'>
                      * By signing you agree to our
                      <Link href='#'>
                        <a className='ms-1'>Privacy policy.</a>
                      </Link>
                    </Form.Text>
                  </Card.Body>
                </Card>
          ...
          <Col lg={8}>
            ...
            <div className='d-flex flex-wrap border-bottom pb-3 mb-4'>
              <Link href='#'>
                <a className='text-uppercase text-decoration-none border-end pe-3 me-3 mb-2'>Travelling</a>
              </Link>
              ...
              <Link href='#'>
                <a className='nav-link-muted d-flex align-items-center mb-2'>
              ...
              <div className='d-md-flex align-items-center justify-content-between border-top pt-4'>
                <div className='d-flex align-items-center me-3 mb-3 mb-md-0'>
                  ...
                  <div className='d-flex flex-wrap'>
                    <Link href='#' passHref>
                      <Button size='xs' variant='outline-secondary rounded-pill fs-sm fw-normal me-2 mb-2'>COVID-19</Button>
                    </Link>
                    <Link href='#' passHref>
                      <Button size='xs' variant='outline-secondary rounded-pill fs-sm fw-normal mb-2'>Travel</Button>
                    </Link>
                  </div>
                </div>
