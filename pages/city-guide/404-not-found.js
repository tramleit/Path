          ...
          <Container className='d-flex justify-content-center text-center'>
            <Col xs={12} md={10} lg={8} className='px-0'>
              ...
              <Link href='/city-guide' passHref>
                <Button size='lg' variant='primary rounded-pill w-sm-auto w-100 mb-3 me-sm-4'>Go to homepage</Button>
              </Link>
              <Link href='/city-guide/contacts' passHref>
                <Button size='lg' variant='outline-primary rounded-pill w-sm-auto w-100 mb-3'>Contact us</Button>
              </Link>
            </Col>
          </Container>
        </section>
