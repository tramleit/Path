                ...
                <Card.Body className='pb-0'>
                  ...
                  {faq.links.map((link, indx) => (
                    <Link key={indx} href={link[0]}>
                      <a className='nav-link mb-2 p-0 fw-normal'>{link[1]}</a>
                    </Link>
                  ))}
                </Card.Body>
              </Card>
      ...
      <Container as='section' className='pb-5 mb-3 mb-lg-5'>
        <div className='rounded-3 bg-faded-accent py-5 px-sm-5 px-4'>
          <div className='mx-auto py-md-4 text-center' style={{maxWidth: '605px'}}>
            ...
            <div className='form-text'>* By signing up you agree to our <Link href='#'><a className='text-decoration-none'>Privacy Policy</a></Link></div>
          </div>
        </div>
      </Container>
    </CityGuidePageLayout>
