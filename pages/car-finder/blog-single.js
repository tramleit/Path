      ...
      <Container as='section' className='mt-5 mb-md-4 py-5'>
        ...
        <Breadcrumb className='breadcrumb-light mb-3 pt-md-3'>
          ...
          <Link href='/car-finder/blog' passHref>
            <Breadcrumb.Item>News &amp; reviews</Breadcrumb.Item>
          </Link>
        ...
        <Row className='mt-4 pt-3'>
          ...
          <Col xs={12} lg={8}>
            ...
            <div className='d-flex flex-wrap border-bottom border-light pb-3 mb-4'>
              <Link href='#'>
                <a className='text-uppercase text-decoration-none border-end border-light pe-3 me-3 mb-2'>Reviews</a>
              </Link>
              ...
              <div className='d-md-flex align-items-center justify-content-between border-top border-light pt-4'>
                <div className='d-flex align-items-center me-3 mb-3 mb-md-0'>
                  ...
                  <div className='d-flex flex-wrap'>
                    <Link href='#' passHref>
                      <Button size='xs' variant='translucent-light rounded-pill fs-sm fw-normal me-2 mb-2'>Reviews</Button>
                    </Link>
                    <Link href='#' passHref>
                      <Button size='xs' variant='translucent-light rounded-pill fs-sm fw-normal me-2 mb-2'>Bikes</Button>
                    </Link>
                    <Link href='#' passHref>
                      <Button size='xs' variant='translucent-light rounded-pill fs-sm fw-normal mb-2'>Harley Davidson</Button>
                    </Link>
                  </div>
                </div>
          ...
          <Col ref={offcanvasContainer} as='aside' lg={4}>
            <Offcanvas
              ...
              placement={'end'}
              className='offcanvas-expand-lg bg-dark'
            >
                  ...
                  <Card.Body className='d-flex align-items-start'>
                    ...
                    <div className='ps-3'>
                      <h4 className='h5 mb-2'>
                        <Link href='#'>
                          <a className='nav-link-light stretched-link p-0 fw-bold'>Kristin Watson</a>
                        </Link>
                      </h4>
