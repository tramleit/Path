    ...
    >
      <Container className='mt-5 mb-md-4 py-5'>
        ...
        <Breadcrumb className='breadcrumb-light mb-3 pt-md-3'>
          ...
          <Link href='/car-finder/catalog' passHref>
            <Breadcrumb.Item>Used cars</Breadcrumb.Item>
          </Link>
          ...
          <Col as='aside' md={5} className='pt-5 pt-md-0' style={{marginTop: '-6rem'}}>
            <div className='sticky-top pt-5'>
              ...
              <div className='card card-light card-body mb-4'>
                ...
                <Link href='/car-finder/vendor'>
                  <a className='d-flex align-items-center text-decoration-none mb-3'>
                ...
                <Link href='/car-finder/vendor'>
                  <a className='text-light'>Other ads by this seller</a>
                </Link>
