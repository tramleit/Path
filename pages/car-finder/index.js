      ...
      <Container as='section' className='pb-5 mb-md-4'>
        <div className='d-sm-flex align-items-center justify-content-between mb-3 mb-sm-4 pb-sm-2'>
          ...
          <Link href='/car-finder/catalog?view=grid' passHref>
            <Button variant='link btn-light fw-normal px-0'>
              View all
            ...
            <Col key={indx}>
              <div className='card card-body card-light card-hover bg-transparent border-0 px-0 pt-0 text-center'>
                ...
                <Link href={category[0]}>
                  <a className='nav-link-light stretched-link fw-bold'>{category[2]}</a>
                </Link>
              </div>
            </Col>
          ))}
        ...
        <Row className='g-2 g-sm-4'>
          {brands.map((brand, indx) => (
            <Col key={indx} xs={3} sm={2} xl={1} className='mb-4 pb-2'>
              <Link href={brand[0]}>
                <a className='d-flex justify-content-center opacity-40 opacity-transition'>
                  <ImageLoader
                    src={brand[1]}
                    width={86}
                    height={48}
              ...
              <Row className='align-items-center py-3 py-sm-0'>
                ...
                <Col md={8} xl={9}>
                  <Row xs={2} lg={4} className='gy-4 gx-3 gx-sm-4'>
                    <Link href='#' passHref>
                      <Col as='a' className='text-light text-center text-decoration-none'>
