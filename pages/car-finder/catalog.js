...
const CatalogPage = () => {
  ...
  // Price range slider
  const PriceRange = () => {
    const [minRange, setMinRange] = useState(25000)
    const [maxRange, setMaxRange] = useState(65000)
              ...
              <Nav activeKey={`/car-finder/catalog?view=${viewParam}`} className='d-none d-sm-flex'>
                <Nav.Item>
                  <Link href='/car-finder/catalog?view=list' passHref>
                    <Nav.Link className='nav-link-light px-2' aria-label='List view'>
                ...
                <Nav.Item>
                  <Link href='/car-finder/catalog?view=grid' passHref>
                    <Nav.Link className='nav-link-light px-2' aria-label='grid view'>
